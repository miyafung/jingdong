<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\goods\add.html";i:1492336144;s:86:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\public\navbar.html";i:1493888042;s:87:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\public\sidebar.html";i:1498195384;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
							...
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="<?php echo url('goods/addhanddle'); ?>" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input id="goods_after_price" name="goods_after_price" placeholder="不促销就不填写" class="col-xs-10 col-sm-5" type="text">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input name="goods_status" class="ace ace-switch ace-switch-7" type="checkbox" value="1" checked="">
										<span class="lbl"></span>
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										...
										<input type="submit" name="" value="添加商品" class="btn btn-info">
