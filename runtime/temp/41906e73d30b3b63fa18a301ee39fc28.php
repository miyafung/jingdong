<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\goods\addproperty.html";i:1492948569;s:86:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\public\navbar.html";i:1493888042;s:87:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\public\sidebar.html";i:1498195384;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="<?php echo url('goods/addpropertyhanddle'); ?>" method="post">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="keywords_name"> 商品名称 </label>

										<div class="col-sm-9">
											<input id="keywords_name" name=""  class="col-xs-10 col-sm-5" type="text" value="<?php echo $goods_find['goods_name']; ?>" readonly="">
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="<?php echo $vo['property_id']; ?>"> <?php echo $vo['property_name']; ?> </label>

										<div class="col-sm-9">
											<input id="<?php echo $vo['property_id']; ?>" name="<?php echo $vo['property_id']; ?>"  class="col-xs-10 col-sm-5" type="text"
												<?php if(is_array($goodsproperty_select_toArray) || $goodsproperty_select_toArray instanceof \think\Collection || $goodsproperty_select_toArray instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsproperty_select_toArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;if($vo['property_id'] == $vo1['property_id']): ?>
													value="<?php echo $vo1['goodsproperty_content']; ?>"
									...
									<div class="clearfix form-actions">
										...
										<input type="submit" name="" value="修改属性" class="btn btn-info">
