<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\login\login.html";i:1495540110;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="<?php echo url('login/checklogin'); ?>" id="form1">
												<fieldset>
													...
													<div><img src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>?seed='+Math.random()"/></div>
													<div class="space"></div>
													...
													<div class="clearfix">
														...
														<button type="button" class="width-35 pull-right btn btn-sm btn-primary" onclick="javascript:document.getElementById('form1').submit()">
															<i class="icon-key"></i>
															Login
														</button>
													</div>
