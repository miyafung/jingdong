<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\goods\goodslist.html";i:1492828366;s:86:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\public\navbar.html";i:1493888042;s:87:"G:\phpStudy2017\PHPTutorial\WWW\jd\public/../application/admin\view\public\sidebar.html";i:1498195384;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<label class="col-sm-3 control-label no-padding-right" for="goods_pid"> 所属分类 ：
										<?php if($cate_find): ?>
											...
											<?php if(is_array($cate_list1) || $cate_list1 instanceof \think\Collection || $cate_list1 instanceof \think\Paginator): $i = 0; $__LIST__ = $cate_list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
															...
															<ul class="submenu" style="display: none;">
																...
																<div class="col-xs-4">
																	...
																	<?php if(is_array($vo2['children']) || $vo2['children'] instanceof \think\Collection || $vo2['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo2['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo3): $mod = ($i % 2 );++$i;?>	
																		<li>&nbsp;&nbsp;&nbsp;
																		<a href="<?php echo url('goods/goodslist',array('goods_pid'=>$vo3['cate_id'])); ?>"><?php echo $vo3['cate_name']; ?></a></li>
												...
												<thead>
													<tr role="row"><!-- <th class="center sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 66px;" aria-label="
														...
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 100px;" aria-label="Domain: activate to sort column ascending">ID</th>
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 118px;" aria-label="Price: activate to sort column ascending">商品名称</th>
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 118px;" aria-label="Price: activate to sort column ascending">缩略图</th>
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 118px;" aria-label="Price: activate to sort column ascending">商品价格</th>
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 118px;" aria-label="Price: activate to sort column ascending">促销价格</th>
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 100px;" aria-label="Price: activate to sort column ascending">商品状态</th>
														...
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 118px;" aria-label="Price: activate to sort column ascending">所属分类</th>
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 118px;" aria-label="Price: activate to sort column ascending">关键字</th>
											...
											<tbody role="alert" aria-live="polite" aria-relevant="all">
												<?php if(is_array($goods_info) || $goods_info instanceof \think\Collection || $goods_info instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
													<tr class="odd">
														...
														<td class=" "><img src="<?php echo $vo['goods_thumb']; ?>" width="100"></td>
